...
{
    /// <inheritdoc />
    public partial class InitialPlatformAuth : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    encrypted_connection_string = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_identity_roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "identity_roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_identity_users_TenantId_DomainUserId",
                table: "identity_users",
                columns: new[] { "TenantId", "DomainUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_identity_users_TenantId_NormalizedEmail",
                table: "identity_users",
